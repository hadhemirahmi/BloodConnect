...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-!x+5+=7$@92p&e8ev8@mj*a#q03u+e_o!)z&n^pg0shl_&5!o4')
...
DEFAULT_FROM_EMAIL = config('EMAIL_HOST_USER', default='noreply@bloodconnect.com')
